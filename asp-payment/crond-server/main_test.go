...
func TestOrder(t *testing.T) {
	...
	//NewSimplePayoutAuditJobServer := service.NewSimplePayoutAuditJobServer()
	//NewSimplePayoutAuditJobServer.SyncPayoutauditAddListCrondJob()
	//NewSimplePayoutAuditJobServer.SyncPayoutAuditCrondJob()

	//orderCrondServer := service.NewSimpleOrderCrondJobServer()
	//orderCrondServer.SyncOrderCrondJob()
}
