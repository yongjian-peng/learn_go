...
const (
	...
	QueryOrderSuccessCode = "00"      // code 成功状态码
	IncomeBankCode        = "1008"    //代收银行编码
	IncomeBankCodeDev     = "MyTest"  //代收银行编码
	PayResponseJson       = "json"    //代收银行编码
	BaseUrlProd           = "https://www.78pay.top"
	OrderCreateUrl        = "/Pay_Index.html"
	QueryOrderUrl         = "/Pay_Trade_query.html"
